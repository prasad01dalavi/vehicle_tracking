...
df = pd.read_csv('mumbai_delhi.csv')
cnt = 0
port = 5200

while True:
    for index, row in df.iterrows():
        longitude = float(row['Longitude'])        #Value from device
        ...
        device_data = '00260003106797269be301000159bf985900002bf88fc00b11ca6416f131ce0050000007000000002a77'
