...
df = pd.read_csv('pune_mumbai.csv')
cnt = 0
port = 5200
...
#--------------------------IMEI--------------------------------------------------------------------
        ...
        #-----------------Ascii String Assigning --------------------------
        device_data = '00260003106797269be301000159bf985900002bf88fc00b11ca6416f131ce004b000007000000002a77'
