...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__login_component__ = __webpack_require__(733);
...
var LoginComponent = (function () {
    function LoginComponent(router, fb, toastrService) {
        this.router = router;
        this.toastrService = toastrService;
        this.form = fb.group({
    ...
    LoginComponent.prototype.onSubmit = function (values) {
        if (values["userid"] == "lmtech" && values["password"] == "lmtech") {
            this.router.navigate(['pages/fleetstatus']);
            this.toastrService.success('Login Success');
        }
        else {
            this.toastrService.error('Invalid User Id or Password');
        }
    };
